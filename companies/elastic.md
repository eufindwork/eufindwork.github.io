...
> 信息丰富度: ⭐⭐ (Elastic 是 distributed-by-default 公司, 没有"年度 grad cohort", 偶有 Junior / Working Student 以 case-by-case 形式发布; 公开数据极薄, Levels.fyi NL 数据多在 C6+ senior, 缺 entry-level)
> 区别于实习: 实习几乎不存在固定项目; **Junior / SWE I** 全职可远程 hire 但更倾向已有合法身份的候选人 (vs. sponsor 新人); 2026 NL Glassdoor 显示 "No Jobs at Elastic in Netherlands" — 即便 Amsterdam HQ 也几乎无 NL-tagged opening [来源 (搜索结果): https://www.glassdoor.com/Jobs/Elastic-Netherlands-Jobs-EI_IE751551.0,7_IL.8,19_IN178.htm]

- **常见岗位名**: **Software Engineer I** / **Software Engineer II** / **Associate Software Engineer** / 偶有 **Working Student** (DE 法律框架, 非 grad); **没有 "Graduate Programme"** 这种品牌 (历史上 LinkedIn 出现过 "Elastigrad" 但已停摆) [来源 (搜索结果): https://uk.linkedin.com/jobs/view/elastigrad-graduate-software-engineer-at-elastic-3153062925]
- **欧洲地点**:
  - **Amsterdam (NL, Keizersgracht 5)**: 名义 HQ, 但 2026-05 Glassdoor 实测 0 个 NL-tagged opening [来源 (搜索结果): https://www.glassdoor.com/Jobs/Elastic-Netherlands-Jobs-EI_IE751551.0,7_IL.8,19_IN178.htm]
  - **London (UK)**: 商务 + 少量 engineering, 是 EMEA 最现实的 in-person hub
  - **Berlin / Munich (DE)**: 历史上有 Working Student 名额 (大学在读半职), 不是真正全职 grad; Elastic DE 职位入口 jobs.elastic.co/jobs/country/germany 实时开放
  - **Madrid / Barcelona (ES)**: 远程优先, 少量 SE I 全职
  - **Remote (EU-wide / "Distributed")**: Elastic 多数员工远程, junior 全职理论可在任何 EU 国家, 但**实操要求已有 work right** [来源 (实际打开过): https://jobs.elastic.co/jobs/city/distributed]
...
- **非EU签证 (全职)**:
  ...
  - **30% ruling (NL 2026)**: SE I 起薪需达到 **€4,357/月 <30 岁 = €52.3K/年** Kennismigrant 阈值, Elastic NL Junior 实际 €60K-€75K 估算**符合**, 但因 NL-based offer 太少几乎用不上 [来源 (实际打开过): https://www.jobbatical.com/blog/netherlands-highly-skilled-migrant-salary-thresholds-2026]
- **薪资范围 (base, gross/年, 2026-05 Levels.fyi NL 数据)**:
  - **Greater Amsterdam Area C6 (mid)**: **€120K-€212K total range, median €158K** (NL 全 level median, 偏 senior) [来源 (实际打开过): https://www.levels.fyi/companies/elastic/salaries/software-engineer/locations/greater-amsterdam-area]
  - **NL 全 level**: **€123K-€176K** range [来源 (搜索结果): https://www.levels.fyi/companies/elastic/salaries/software-engineer/locations/netherlands]
  - **Amsterdam SE I (entry)**: 公开数据极少, 按 Amsterdam 2026 entry-level baseline 推算 **€60K-€75K base** + RSU [来源 (搜索结果): https://whatisthesalary.com/it-salaries/software-engineer-salary-amsterdam/]
  - **London SE I**: **£60K-£75K base** + RSU
  - **Berlin SE I**: **€60K-€75K base** + RSU
  - **US 全 level Elastic SWE 范围**: $74.5K - $98.3K (median 偏低端) [来源 (搜索结果): https://www.levels.fyi/companies/elastic/salaries/software-engineer]
  - **股权**: ESTC (NYSE) RSU, 4 年 vest (25-25-25-25, Y1 quarterly, Y2+ semi-annual); Junior 通常 $20K-$40K initial grant
- **申请窗口**: 完全 rolling, 通过 jobs.elastic.co 滚动开放; 没有秋季 batch; 关注 Career portal 的 "Software Engineer" + filter "Junior" / "I" / "Associate"; 平均 hiring 周期 32 天 [来源 (搜索结果): https://www.glassdoor.com/Interview/Elastic-Interview-Questions-E1166989.htm]
- **面试流程差异 vs 实习**:
...
- **关键链接**:
  ...
  - Elastic NL 职位入口 (2026 几乎空): https://jobs.elastic.co/jobs/country/netherlands
  - Elastic DE 职位入口 (Working Student 常见): https://jobs.elastic.co/jobs/country/germany
  - Elastic Distributed (远程) 职位: https://jobs.elastic.co/jobs/city/distributed
  - Levels.fyi Elastic SWE Greater Amsterdam (2026-05 实读 C6 €120K-€212K): https://www.levels.fyi/companies/elastic/salaries/software-engineer/locations/greater-amsterdam-area
...
- Levels.fyi Elastic SWE Greater Amsterdam (2026-05 实读): https://www.levels.fyi/companies/elastic/salaries/software-engineer/locations/greater-amsterdam-area
...
- Elastic Distributed (远程) 职位入口: https://jobs.elastic.co/jobs/city/distributed
- Elastic DE country 入口 (Working Student): https://jobs.elastic.co/jobs/country/germany
